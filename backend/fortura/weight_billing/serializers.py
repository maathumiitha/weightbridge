...
class ReportDataSerializer(serializers.Serializer):
    ...
    operator_first_weight_name = serializers.CharField()
    operator_second_weight_name = serializers.CharField()
    first_weight = serializers.DecimalField(max_digits=10, decimal_places=2)
    ...
    net_weight = serializers.DecimalField(max_digits=10, decimal_places=2)
